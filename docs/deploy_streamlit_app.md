...
2. (recommended) Add a "requirements file" to manage any external dependencies
    1. [Python dependencies](https://www.notion.so/ea5258385fd04685b15ccdac8f28c10f)
    2. [apt-get dependencies](https://www.notion.so/ea5258385fd04685b15ccdac8f28c10f) (for Linux applications outside python environment)
